...
public class TestDFS {
	...
	private static DFS dfs1;
	private static DFS dfs2;
	...
	public static void setUpBeforeClass() throws Exception {
		...
		//Creates DFS implementations from source City objects
		dfs1 = new DFS(map, map.findCity("San Antonio"));
		dfs2 = new DFS(map, map.findCity("Los Angeles"));
	}
	...
	public void testPathTo() {
		...
		route1.add(map.findCity("San Francisco"));
		route1.add(map.findCity("Portland"));
		route1.add(map.findCity("Seattle"));
		route1.add(map.findCity("Salt Lake City"));
		route1.add(map.findCity("Las Vegas"));
		...
		route1.add(map.findCity("Memphis"));
		route1.add(map.findCity("Atlanta"));
		...
		for(City i : dfs2.pathTo(map.findCity("Jacksonville"))) {
		...
		index = 0;
		samePath = true;
		for(City i : dfs1.pathTo(map.findCity("San Antonio"))) {
		...
		index = 0;
		samePath = true;
		for(City i : dfs2.pathTo(map.findCity("Seattle"))) {
		...
		Iterable<City> routeNull = dfs2.pathTo(map.findCity("Boston"));
